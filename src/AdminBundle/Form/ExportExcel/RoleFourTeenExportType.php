...
/**
 * Class RoleFourTeenExportType
 *
 * @package AdminBundle\Form\ExportExcel
 */
class RoleFourTeenExportType extends AbstractExportType
{
    /**
     * Builds the form.
     *
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('carlineDate', CheckboxType::class, [
                'required' => false,
                'label' => 'Carline Datum'
            ])
            ->add('carlineNumber', CheckboxType::class, [
                'required' => false,
                'label' => 'carlineNumber C.'
            ])
