...
/**
 * Class RoleTwelveCarType
 *
 * @package AdminBundle\Form\Car
 */
class RoleTwelveCarType extends AbstractCarType
{
    /**
     * Builds the form.
     *
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('carCondition', ChoiceType::class, $this->getCarCondition($builder, UserRoleEnum::ROLE_ADMIN_12))
            ...
            ->add('paid', null, ['required' => false, 'disabled' => true])
