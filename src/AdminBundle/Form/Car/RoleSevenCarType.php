...
/**
 * Class RoleSevenCarType
 *
 * @package AdminBundle\Form\Car
 */
class RoleSevenCarType extends AbstractCarType
{
    /**
     * Builds the form.
     *
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('colorPolish', null, ['required' => false, 'choice_label' => 'polish', 'attr' => ['readonly' => 'readonly']])
            ...
            ->add('complectationPolish', null, ['required' => false, 'disabled' => 'disabled'])
