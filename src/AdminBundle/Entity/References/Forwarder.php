 ...
 * Class Forwarder
 *
 * @ORM\Entity(repositoryClass="AdminBundle\Repository\References\ForwarderRepository")
 *
 * @package AdminBundle\Entity\References
 */
class Forwarder extends AbstractReferences
{
    /**
     * @ORM\OneToMany(
     ...
     * @return Forwarder
     */
    public function addCar(Car $car): Forwarder
    {
        $this->car[] = $car;
