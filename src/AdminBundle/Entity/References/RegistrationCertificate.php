 ...
 *
 * @ORM\Entity(repositoryClass="AdminBundle\Repository\References\RegistrationCertificateRepository")
 *
 * @package AdminBundle\Entity\References
 */
class RegistrationCertificate extends AbstractReferences
{
    /**
     * @var string
     *
     ...
     *     mappedBy="registrationCertificate",
     *     cascade={ "persist" }
     * )
     */
    private $car;
     ...
     */
    public function addCar(Car $car): RegistrationCertificate
    {
        $this->car[] = $car;
